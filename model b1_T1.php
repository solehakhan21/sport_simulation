...
modal.style.width = "820px";   // FIXED WIDTH EXACT LIKE YOUR SCREENSHOT
...
modal.innerHTML = `
    ...
    <div class="relative bg-[#1f8f00] text-white flex justify-between px-4 py-3 font-bold text-sm">
        ...
        <div class="flex-1 text-center">Team 1 - SINGAPORE</div>
        <div class="flex-1 text-center">Team 2 - MALAYSIA</div>
        ...
        <table class="w-full text-center border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="py-2 border-r">HO Kee Keng</td>
                    <td class="py-2">HAMIZI Pabil</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">1</td>
                    <td class="py-2 border-r">HUANG Kang Kang</td>
                    <td class="py-2">KUEH Wan May</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">2</td>
                    <td class="py-2 border-r">HENG Wei Chen</td>
                    <td class="py-2">HO Li Na</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">3</td>
                    <td class="py-2 border-r">HO Jia Ren Jason</td>
                    <td class="py-2">H'NG Kim Shan</td>
                </tr>
    ...
    <!-- NEXT MATCH (RECTANGLE EXACT LIKE YOUR SCREENSHOT) -->
