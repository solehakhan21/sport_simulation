...
// FULL MODAL CONTENT (DATA UPDATED)
modal.innerHTML = `

    <!-- HEADER TITLE -->
    <div class="text-2xl font-bold text-green-700 px-4 py-4">
        You have chosen match JAPAN VS FRANCE
    </div>
    ...
    <div class="relative bg-[#1f8f00] text-white flex justify-between px-4 py-3 font-bold text-sm">
        ...
        <div class="flex-1 text-center">Team 1 - JAPAN</div>
        <div class="flex-1 text-center">Team 2 - FRANCE</div>
        ...
        <table class="w-full text-center border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-300">
                    ...
                    <td class="py-2 border-r">SAITO Kiyoshi</td>
                    <td class="py-2">BAHAUAD Jerome</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">1</td>
                    <td class="py-2 border-r">MATSUMOTO Yukino</td>
                    <td class="py-2">BARON Valene</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">2</td>
                    <td class="py-2 border-r">ITO Mima</td>
                    <td class="py-2">AUBRY Patricia</td>
                </tr>

                <tr class="border-b border-gray-300">
                    <td class="w-16 py-2 border-r font-bold">3</td>
                    <td class="py-2 border-r">MIYAZAKI Yoshihito</td>
                    <td class="py-2">AUFERRE Julien</td>
                </tr>
